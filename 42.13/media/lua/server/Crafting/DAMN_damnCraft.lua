...
function DAMN.OnCreate.MakeRubberStrips(craftRecipeData, character)
    ...
    if tireCond < 26 then
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.RubberStrip",});
    elseif tireCond < 81 then
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.RubberStrip", amount = 3,});
    else
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.RubberStrip", amount = 6,});
    end
...
function DAMN.OnCreate.GetScrapMetal(craftRecipeData, character)
    ...
    if chance < 41 then
        DAMN:addItemsToPlayerInventory({itemId = "Base.ScrapMetal",});
    elseif chance < 82 then
        DAMN:addItemsToPlayerInventory({itemId = "Base.ScrapMetal", amount = 2,});
    else
        DAMN:addItemsToPlayerInventory({itemId = "Base.ScrapMetal", amount = 4,});
    end
...
function DAMN.OnCreate.DismantleTireSmallMounted(craftRecipeData, character)
    ...
    if itemCond < 26 then
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.TireRubberDestroyedSmall",});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.TireRubberUsedSmall",});
    else
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.TireRubberNewSmall",});
    end
...
function DAMN.OnCreate.DismantleTireLargeMounted(craftRecipeData, character)
    ...
    if itemCond < 26 then
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.TireRubberDestroyedLarge",});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.TireRubberUsedLarge",});
    else
        DAMN:addItemsToPlayerInventory({itemId = "damnCraft.TireRubberNewLarge",});
    end
...
function DAMN.OnCreate.DismantleHood(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({itemId = "Base.ScrapMetal",});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({itemId = "Base.ScrapMetal", amount = 3,});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeLarge", amount = 2,}, {itemId = "Base.Screws",}, {itemId = "Base.SheetMetal",}});
    end
end
...
function DAMN.OnCreate.DismantleTrunkLid(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({itemId = "Base.ScrapMetal",});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}, {itemId = "damnCraft.HingeLarge",}, {itemId = "Base.Screws",}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeLarge", amount = 2,}, {itemId = "Base.Screws",}, {itemId = "Base.SheetMetal",}});
    end
end
...
function DAMN.OnCreate.DismantleTrunkLids(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({itemId = "Base.ScrapMetal",});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeLarge", amount = 2,}, {itemId = "Base.Screws",}, {itemId = "Base.ScrapMetal",}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeLarge", amount = 4,}, {itemId = "Base.Screws", amount = 2,}, {itemId = "Base.SheetMetal", amount = 2,}});
    end
end
...
function DAMN.OnCreate.DismantleDoorModern(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeSmall",}, {itemId = "Base.ScrapMetal",}});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeSmall",}, {itemId = "Base.ScrapMetal",}, {itemId = "damnCraft.HandleModern",}, {itemId = "Base.Screws",}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeSmall", amount = 2,}, {itemId = "Base.Wire",}, {itemId = "damnCraft.HandleModern",}, {itemId = "Base.Screws",}, {itemId = "Base.SheetMetal",}});
    end
end
...
function DAMN.OnCreate.DismantleDoorClassic(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeSmall",}, {itemId = "Base.ScrapMetal",}});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeSmall",}, {itemId = "Base.ScrapMetal",}, {itemId = "damnCraft.HandleClassic",}, {itemId = "Base.Screws",}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.HingeSmall", amount = 2,}, {itemId = "Base.Wire",}, {itemId = "damnCraft.HandleClassic",}, {itemId = "Base.Screws",}, {itemId = "Base.SheetMetal",}});
    end
end
...
function DAMN.OnCreate.DismantleWindshield(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.RubberStrip",}, {itemId = "Base.BrokenGlass",}});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.RubberStrip",}, {itemId = "Base.BrokenGlass",}, {itemId = "Base.GlassPanel",}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.RubberStrip", amount = 2,}, {itemId = "Base.GlassPanel", amount = 2,}});
    end
end
...
function DAMN.OnCreate.DismantleWindow(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.BrokenGlass",}});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.BrokenGlass",}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "Base.GlassPanel",}});
    end
end
...
function DAMN.OnCreate.DismantleWoodenArmor(craftRecipeData, character)
    ...
    if itemCond < 26 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.UnusableWood",}});
    elseif itemCond < 70 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.Plank",}, {itemId = "Base.UnusableWood",}, {itemId = "Base.Nails", amount = 2,}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "Base.Plank", amount = 2}, {itemId = "Base.UnusableWood",}, {itemId = "Base.Nails", amount = 3,}});
    end
end
...
function DAMN.OnCreate.DismantleMetalArmor(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}, {itemId = "Base.MetalPipe",}, {itemId = "Base.Screws",}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}, {itemId = "Base.MetalPipe",}, {itemId = "Base.SmallSheetMetal",}, {itemId = "Base.Screws",}});
    end
end
...
function DAMN.OnCreate.DismantleMudflaps(craftRecipeData, character)
    ...
    if itemCond < 50 then
        ...
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.RubberStrip", amount = 2,}});
    end
end
...
function DAMN.OnCreate.DismantleSidesteps(craftRecipeData, character)
    ...
    if itemCond < 10 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}});
    elseif itemCond < 81 then
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}, {itemId = "Base.Screws",}});
    else
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}, {itemId = "Base.SmallSheetMetal",}, {itemId = "Base.Screws",}});
    end
end
...
function DAMN.OnCreate.DismantleMetalBumper(craftRecipeData, character)
    ...
    elseif itemCond < 81 then
        ...
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}, {itemId = "Base.SmallSheetMetal", amount = 2,}, {itemId = "Base.Screws",}});
    end
end
...
function DAMN.OnCreate.DismantleMetalRoofrack(craftRecipeData, character)
    ...
    elseif itemCond < 81 then
        ...
        DAMN:addItemsToPlayerInventory({{itemId = "Base.ScrapMetal",}, {itemId = "Base.MetalPipe", amount = 2,}, {itemId = "Base.Screws", amount = 2,}});
    end
end
...
function DAMN.OnCreate.DismantleToolbox(craftRecipeData, character)
    ...
    elseif itemCond < 81 then
        ...
        DAMN:addItemsToPlayerInventory({{itemId = "Base.SheetMetal",}, {itemId = "Base.Screws",}});
    end
end
...
function DAMN.OnCreate.DismantleTarpSmall(craftRecipeData, character)
    ...
    elseif itemCond < 81 then
        ...
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.RubberStrip",}, {itemId = "Base.Tarp",}});
    end
end
...
function DAMN.OnCreate.DismantleTarpLarge(craftRecipeData, character)
    ...
    elseif itemCond < 81 then
        ...
        DAMN:addItemsToPlayerInventory({{itemId = "damnCraft.RubberStrip",}, {itemId = "Base.Tarp", amount = 2,}});
    end
end
